...
export class MayanCalculator {
    static calculate(dateString: string) {
        ...
        // Es la constante aceptada universalmente para la sincronización con el calendario Gregoriano.
        // El JD 584283 equivale a 4 Ajpu. Al restar esto asumiendo el día 0, establecemos nuestra base matemática.
        const tzolkinDays = Math.floor(jd - 584283);

        // En GMT 584283, tzolkinDays = 0 equivale al Nahual Ajpu. 
        // Ajpu es el índice 9 en nuestro arreglo NAWALES.
