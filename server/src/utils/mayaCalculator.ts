// Constants for Mayan Nawales and Tones (Bilingual)
export const NAWALES = [
    {
        "id": 0,
        "name": "B'atz'",
        "meaning": {
            "es": "Hilo, Tiempo, Tejedor",
            "en": "Thread, Time, Weaver"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Ix",
        "meaning": {
            "es": "Jaguar, Magia Femenina",
            "en": "Jaguar, Feminine Magic"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Tz'ikin",
        "meaning": {
            "es": "Pájaro, Visión, Libertad",
            "en": "Bird, Vision, Freedom"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Ajmaq",
        "meaning": {
            "es": "Búho, Perdón, Ancestros",
            "en": "Owl, Forgiveness, Ancestors"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "No'j",
        "meaning": {
            "es": "Sabiduría, Idea, Cerebro",
            "en": "Wisdom, Idea, Brain"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Tijax",
        "meaning": {
            "es": "Obsidiana, Cuchillo, Sanación",
            "en": "Obsidian, Knife, Healing"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Kawoq",
        "meaning": {
            "es": "Tormenta, Comunidad, Familia",
            "en": "Storm, Community, Family"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Imox",
        "meaning": {
            "es": "Cocodrilo, Agua, Locura Divina",
            "en": "Crocodile, Water, Divine Madness"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Iq'",
        "meaning": {
            "es": "Viento, Aliento de Vida",
            "en": "Wind, Breath of Life"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "K'at",
        "meaning": {
            "es": "Red, Fuego, Cautiverio",
            "en": "Net, Fire, Captivity"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Kan",
        "meaning": {
            "es": "Serpiente, Justicia, Energía Vital",
            "en": "Serpent, Justice, Vital Energy"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Kej",
        "meaning": {
            "es": "Venado, Bosque, Autoridad",
            "en": "Deer, Forest, Authority"
        },
        "description": {
    ...
    },
    {
        ...
        "name": "Toj",
        "meaning": {
            "es": "Ofrenda, Pago, Fuego",
            "en": "Offering, Payment, Fire"
        },
        "description": {
...
export class MayanCalculator {
    static calculate(dateString: string, lang: 'es' | 'en' = 'es') {
        ...
        const description = nawalData.description[lang] || nawalData.description.es;
        const shortDescription = description.split('.')[0];
        
        const mission = lang === 'es' 
            ? `Misión de ${nawalData.name}: ${meaning}. Expandir la conciencia a través de ${shortDescription}.`
            : `Mission of ${nawalData.name}: ${meaning}. Expand consciousness through ${shortDescription}.`;
            
        const challenges = lang === 'es'
            ? `Desafío: Integrar la sombra de ${nawalData.name} y usar su energía para construir, no para destruir.`
            : `Challenge: Integrate the shadow of ${nawalData.name} and use its energy to build, not destroy.`;
